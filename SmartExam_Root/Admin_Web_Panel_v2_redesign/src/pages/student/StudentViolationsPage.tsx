                ...
                >
                  ...
                  <div className="flex items-center gap-6 text-xs text-slate-500 mb-4">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span>{violation.recordedAt ? format(new Date(violation.recordedAt), 'MMM dd, yyyy') : 'Recently'}</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <Clock size={14} className="text-slate-400" />
                      <span>{violation.recordedAt ? format(new Date(violation.recordedAt), 'hh:mm a') : 'Unspecified'}</span>
                    </div>
                  </div>
