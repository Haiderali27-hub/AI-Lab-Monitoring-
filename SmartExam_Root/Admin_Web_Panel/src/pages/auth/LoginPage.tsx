        ...
        <section className="bg-white flex flex-col items-center justify-center p-8 relative">
          <div className="w-full max-w-[400px]">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              {/* Submit Button */}
              <button
                className="w-full h-[44px] bg-gradient-to-r from-primary-600 to-primary-700 text-white font-semibold text-sm rounded-lg hover:from-primary-500 hover:to-primary-600 transition-all active:scale-[0.98] shadow-md shadow-primary-600/20 disabled:opacity-50 flex items-center justify-center gap-2"
                type="submit"
                disabled={loading}
              >
                {loading ? (
