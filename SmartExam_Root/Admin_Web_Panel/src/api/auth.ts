...
export async function registerOrganization(payload: BootstrapPayload): Promise<TokenResponse> {
  return unwrap<TokenResponse>(apiClient.post('/api/auth/register-organization', payload))
}
