...
\hline\hline
FR1 & Admin can manage user accounts and role permissions. \\
FR2 & Students can authenticate, and the system shall enforce device binding via HWID check. \\
FR3 & Students can verify hardware readiness and permissions prior to the exam. \\
FR4 & Students can view scheduled exams and instructions on the dashboard. \\
FR5 & The student client shall lock down the workstation and restrict unauthorized application usage. \\
FR6 & The student client shall stream screenshots, focus logs, and process list telemetry. \\
FR7 & Students can submit exams, and the system shall support manual and auto-save submissions. \\
FR8 & Teachers can configure exams, allowed apps lists, coding/theory questions, and test cases. \\
FR9 & Teachers can control exam eligibility using seating maps or manual overrides. \\
FR10 & Teachers can monitor student focus timelines, active processes, and violations live. \\
FR11 & The system shall compile and grade coding submissions automatically using test cases. \\
...
FR14 & Admin and teachers can view audit logs and generate analytical PDF exam reports. \\
\hline\hline
\end{tabular}
\end{table}
...
Evidence handling is equally important. The system should maintain structured linkage between the submission, the student identity, the assigned exam, the session timing, and the relevant event history. This evidence-oriented requirement supports academic fairness because it enables instructors or reviewers to interpret a submission within its full examination context. For example, if a technical interruption or suspicious event occurred, the evidence record should help explain that context during review.
